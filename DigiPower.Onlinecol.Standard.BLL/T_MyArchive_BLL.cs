...
{
    /// <summary>
    /// 业务逻辑类T_MyArchive_BLL 的摘要说明。
    /// </summary>
    public class T_MyArchive_BLL
    {
        private readonly DigiPower.Onlinecol.Standard.DAL.T_MyArchive_DAL dal = new DigiPower.Onlinecol.Standard.DAL.T_MyArchive_DAL();
        public T_MyArchive_BLL()
        { }
        #region  成员方法
        ...
        /// 得到一个对象实体，从缓存中。
        /// </summary>
        public DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL GetModelByCache(int ArchiveID)
        {

            string CacheKey = "T_MyArchive_MDLModel-" + ArchiveID;
            ...
            return (DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL> DataTableToList(DataTable dt)
        {
            List<DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL> modelList = new List<DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new DigiPower.Onlinecol.Standard.Model.T_MyArchive_MDL();
        ...
        {
            dal.updateFileOrderIndexByArchiveID(MyArchiveID, OrderBy);
        }
        ...
        {
            dal.DeleteArchiveMore(MyArchiveID);
        }
