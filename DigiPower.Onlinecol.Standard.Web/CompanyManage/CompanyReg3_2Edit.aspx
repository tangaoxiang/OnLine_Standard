<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSon.Master" AutoEventWireup="true" CodeBehind="CompanyReg3_2Edit.aspx.cs" Inherits="DigiPower.Onlinecol.Standard.Web.CompanyManage.CompanyReg3_2Edit" %>
...
<%@ Register Src="../CommonCtrl/ctrlArchiveFormType.ascx" TagName="ctrlArchiveFormType"
    TagPrefix="uc4" %>
<%@ Register Src="../CommonCtrl/ctrlCompanyRegBaseInfo3_2.ascx" TagName="ctrlCompanyRegBaseInfo3_2"
    TagPrefix="uc1" %>
<%@ Register Src="../CommonCtrl/ctrlCompanyRegBaseInfo3_2Ext.ascx" TagName="ctrlCompanyRegBaseInfo3_2Ext"
    TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <uc1:ctrlCompanyRegBaseInfo3_2 ID="ctrlCompanyRegBaseInfo3_22" runat="server" />
    <table class="zpxxxj" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td colspan="4"><strong id="tbzyjz" style="cursor: pointer;" title="展开/关闭">
                <span id="spSingleProjectdetail">市政基础设施专业记载</span>
                <%--<img src="../Javascript/Layer/image/t.png" id="tbzyjzimg" alt="" />--%>
            </strong></td>
        </tr>
    </table>
    <uc2:ctrlCompanyRegBaseInfo3_2Ext ID="ctrlCompanyRegBaseInfo3_2Ext1" runat="server" />
    <table class="zpxxxj" border="0" cellspacing="0" cellpadding="0">
        <tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        if(ProjectType=="2"){
            $("#spSingleProjectdetail").text("市政道路工程专业记载");
            $("#ctl00_Main_ctrlCompanyRegBaseInfo3_2Ext1_tabledetail").find("tr[trtitle='bridge']").hide();
        }else if(ProjectType=="3"){
            $("#spSingleProjectdetail").text("市政桥梁工程专业记载");
            $("#ctl00_Main_ctrlCompanyRegBaseInfo3_2Ext1_tabledetail").find("tr[trtitle='road']").hide();
        }
        ...
        $("#tbzyjz").click(function () {
            var obj = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_2Ext1_tabledetail");
            //var img = $("#tbzyjzimg");
            if (obj.is(":hidden")) {
        ...
        function saveSubmit(obj) {
            ...
            var dt1 = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_22_kgsj_TextBox1");
            var dt2 = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_22_jgsj_TextBox1");
