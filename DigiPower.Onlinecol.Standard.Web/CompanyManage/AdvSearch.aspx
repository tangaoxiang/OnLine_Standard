<%@ Page Language="C#" MasterPageFile="~/SiteParent.Master" AutoEventWireup="true" CodeBehind="AdvSearch.aspx.cs"
    Inherits="DigiPower.Onlinecol.Standard.Web.CompanyManage.AdvSearch" Title="入库工程档案查询" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function btnLookArchive() {
            if (Common.isRadioCheck()) {
                ...
                var url = "../WorkFlow/InsideRemove.aspx?SingleProjectID=" +
                keyList[0] + "&ProjectType=" + keyList[1] + "&Archive_Form=" + <%=ProjectType%> + "&rn=" + Math.random();
        ...
        <div class="content-box-content">
            <div class="tab-content default-tab" id="tab1">
                <div class="anl" id="anlButtonList">
                    ...
                    <input type="button" id="MrcBtnLookArchive" title="案卷详细信息" onclick="btnLookArchive()" value="案卷信息" />
                </div>
                <table>
                    <thead>
                        <tr>
