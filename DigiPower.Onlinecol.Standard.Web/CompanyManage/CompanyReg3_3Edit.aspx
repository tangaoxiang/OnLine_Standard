<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSon.Master" AutoEventWireup="true" CodeBehind="CompanyReg3_3Edit.aspx.cs" Inherits="DigiPower.Onlinecol.Standard.Web.CompanyManage.CompanyReg3_3Edit" %>
...
<%@ Register Src="../CommonCtrl/ctrlArchiveFormType.ascx" TagName="ctrlArchiveFormType"
    TagPrefix="uc4" %>
<%@ Register Src="../CommonCtrl/ctrlCompanyRegBaseInfo3_3.ascx" TagName="ctrlCompanyRegBaseInfo3_3"
    TagPrefix="uc1" %>
<%@ Register Src="../CommonCtrl/ctrlCompanyRegBaseInfo3_3Ext.ascx" TagName="ctrlCompanyRegBaseInfo3_3Ext"
    TagPrefix="uc2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <table class="zpxxxj" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td>
                <uc6:ctrlDropDownArea ID="AREA_CODE" runat="server" Width="150" />
            </td>
        </tr>
    </table>
    <uc1:ctrlCompanyRegBaseInfo3_3 ID="ctrlCompanyRegBaseInfo3_33" runat="server" />
    <table class="zpxxxj" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td colspan="4"><strong id="tbzyjz" style="cursor: pointer;" title="展开/关闭">其它/地下专业管线 
                <%--<img src="../Javascript/Layer/image/t.png" id="tbzyjzimg" alt="" />--%>
            </strong></td>
        </tr>
    </table>
    <uc2:ctrlCompanyRegBaseInfo3_3Ext ID="ctrlCompanyRegBaseInfo3_3Ext1" runat="server" />
    <table class="zpxxxj" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td class="lljzc" style="height: 30px;">
                <asp:Button ID="btnSave" runat="server" Text=" 保存 "
                    OnClientClick="return saveSubmit(this);" clickflag="ok" OnClick="btnSave_Click" />
                <input type="button" id="btngoBack" value=" 返回 "
                    onclick="Common.fnParentLayerClose()" />
            </td>
        </tr>
    </table>
    <br />
    ...
    <script language="javascript" type="text/javascript">
        ...
        $("#tbzyjz").click(function () {
            var obj = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_3Ext1_tabledetail");
            //var img = $("#tbzyjzimg");
            if (obj.is(":hidden")) {
        ...
        function saveSubmit(obj) {
            ...
            var dt1 = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_33_kgsj_TextBox1");
            var dt2 = $("#ctl00_Main_ctrlCompanyRegBaseInfo3_33_jgsj_TextBox1");
