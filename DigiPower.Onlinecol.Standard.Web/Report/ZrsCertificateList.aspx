<%@ Page Language="C#" MasterPageFile="~/SiteParent.Master" AutoEventWireup="true" CodeBehind="ZrsCertificateList.aspx.cs"
    Inherits="DigiPower.Onlinecol.Standard.Web.Report.ZrsCertificateList" Title="机构管理" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function btnExportExcel(obj) {
            if ($(obj).attr("clickflag") == 'ok') {
                ...
                var exlName = ZrsCertificateList.ExportExcel(r1, r2, r3).value;
