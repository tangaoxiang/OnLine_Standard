<%@ Page Title="" Language="C#" MasterPageFile="~/SiteSon.Master" AutoEventWireup="true" CodeBehind="ArchiveCheck.aspx.cs" Inherits="DigiPower.Onlinecol.Standard.Web.WorkFlow.ArchiveCheck" %>
