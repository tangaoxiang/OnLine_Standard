...
{
	/// <summary>
	/// 数据访问类construction_project_c_DAL。
	/// </summary>
	public class construction_project_c_DAL
	{
		public construction_project_c_DAL()
		{}
		#region  成员方法
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ConstructionProjectID", "construction_project_c"); 
		}
		...
		public bool Exists(int ConstructionProjectID)
		{
			...
			strSql.Append("select count(1) from construction_project_c");
		...
		/// 增加一条数据
		/// </summary>
		public void Add(DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into construction_project_c(");
			strSql.Append("ConstructionProjectID,area_code,dh,gcmc,gcdd,jsdw,lxpzdw,sjdw,jgcldw,jldw,lxpzwh,ghxkzh,ydghxkzh,ydxkzh,sgxkzh,qd,zd,zcd,kgsj,jgsj,gczj,gczj_Bak,gcjs,zajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,gisid,ywzd,xmbh,bjlxr,lxdh,yddw,bzdw,kcdw,sgdw,gcxh,zlyj,TJLB,jsdw_xmfzr,gcqy,wzz)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@jgcldw", SqlDbType.VarChar,80),
					...
					new SqlParameter("@lrr", SqlDbType.VarChar,100),
					...
					new SqlParameter("@gcxh", SqlDbType.VarChar,20),
			...
			parameters[8].Value = model.jgcldw;
			...
			parameters[15].Value = model.qd;
			parameters[16].Value = model.zd;
			...
			parameters[52].Value = model.yddw;
			parameters[53].Value = model.bzdw;
			parameters[54].Value = model.kcdw;
			parameters[55].Value = model.sgdw;
			parameters[56].Value = model.gcxh;
			parameters[57].Value = model.zlyj;
			parameters[58].Value = model.TJLB;
			parameters[59].Value = model.jsdw_xmfzr;
			parameters[60].Value = model.gcqy;
			parameters[61].Value = model.wzz;
		...
		/// 更新一条数据
		/// </summary>
		public void Update(DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update construction_project_c set ");
		...
		public void Delete(int ConstructionProjectID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from construction_project_c ");
			strSql.Append(" where ConstructionProjectID=@ConstructionProjectID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ConstructionProjectID", SqlDbType.Int,8)};
			parameters[0].Value = ConstructionProjectID;
		...
		/// 得到一个对象实体
		/// </summary>
		public DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL GetModel(int ConstructionProjectID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ConstructionProjectID,area_code,dh,gcmc,gcdd,jsdw,lxpzdw,sjdw,jgcldw,jldw,lxpzwh,ghxkzh,ydghxkzh,ydxkzh,sgxkzh,qd,zd,zcd,kgsj,jgsj,gczj,gczj_Bak,gcjs,zajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,gisid,ywzd,xmbh,bjlxr,lxdh,yddw,bzdw,kcdw,sgdw,gcxh,zlyj,TJLB,jsdw_xmfzr,gcqy,wzz from construction_project_c ");
			strSql.Append(" where ConstructionProjectID=@ConstructionProjectID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ConstructionProjectID", SqlDbType.Int,8)};
			parameters[0].Value = ConstructionProjectID;

			DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL model=new DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				model.gcxh=ds.Tables[0].Rows[0]["gcxh"].ToString();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select ConstructionProjectID,area_code,dh,gcmc,gcdd,jsdw,lxpzdw,sjdw,jgcldw,jldw,lxpzwh,ghxkzh,ydghxkzh,ydxkzh,sgxkzh,qd,zd,zcd,kgsj,jgsj,gczj,gczj_Bak,gcjs,zajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,gisid,ywzd,xmbh,bjlxr,lxdh,yddw,bzdw,kcdw,sgdw,gcxh,zlyj,TJLB,jsdw_xmfzr,gcqy,wzz ");
			strSql.Append(" FROM construction_project_c ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "construction_project_c";
