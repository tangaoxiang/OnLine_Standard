...
{
	/// <summary>
	/// 业务逻辑类construction_project_c_BLL 的摘要说明。
	/// </summary>
	public class construction_project_c_BLL
	{
		private readonly DigiPower.Onlinecol.Standard.DAL.construction_project_c_DAL dal=new DigiPower.Onlinecol.Standard.DAL.construction_project_c_DAL();
		public construction_project_c_BLL()
		{}
		#region  成员方法
		...
		/// 得到一个对象实体，从缓存中。
		/// </summary>
		public DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL GetModelByCache(int ConstructionProjectID)
		{
			
			string CacheKey = "construction_project_c_MDLModel-" + ConstructionProjectID;
			...
			return (DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL> DataTableToList(DataTable dt)
		{
			List<DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL> modelList = new List<DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new DigiPower.Onlinecol.Standard.Model.construction_project_c_MDL();
					...
					model.gcxh=dt.Rows[n]["gcxh"].ToString();
