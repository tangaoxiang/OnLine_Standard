...
{
	/// <summary>
	/// 实体类construction_project_b_MDL 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public class construction_project_b_MDL
	{
		public construction_project_b_MDL()
		{}
		#region Model
		...
		private decimal? _zydmj;
		private decimal? _zjzmj;
		private decimal? _zcd;
		private DateTime? _kgsj;
		private DateTime? _jgsj;
		private decimal? _gczj;
		private decimal? _gczj_bak;
		...
		private string _bjlxr;
		private string _lxdh;
		private string _zlyj;
		private string _gcqy;
		private string _jsdw_xmfzr;
		private string _tjlb;
		private decimal? _lfl;
		...
		/// 
		/// </summary>
		public decimal? gczj_Bak
		{
			set{ _gczj_bak=value;}
			get{return _gczj_bak;}
		}
		/// <summary>
		/// 
		/// </summary>
		...
		/// 
		/// </summary>
		public string jsdw_xmfzr
		{
			set{ _jsdw_xmfzr=value;}
			get{return _jsdw_xmfzr;}
		}
		/// <summary>
		/// 
		/// </summary>
