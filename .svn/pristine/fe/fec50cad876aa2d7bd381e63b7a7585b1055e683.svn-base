<%@ Page Language="C#" MasterPageFile="~/SiteParent.Master" AutoEventWireup="true" CodeBehind="ZmsCertificateList.aspx.cs"
    Inherits="DigiPower.Onlinecol.Standard.Web.Report.ZmsCertificateList" Title="机构管理" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function btnExportExcel(obj) {
            if ($(obj).attr("clickflag") == 'ok') {
                ...
                var exlName = ZmsCertificateList.ExportExcel(r1, r2, r3).value;
