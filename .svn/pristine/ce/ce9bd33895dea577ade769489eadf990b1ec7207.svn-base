<%@ Page Language="C#" MasterPageFile="~/SiteSon.Master" AutoEventWireup="true" CodeBehind="MyArchiveAdd.aspx.cs"
    Inherits="DigiPower.Onlinecol.Standard.Web.WorkFlow.MyArchiveAdd" Title="案卷管理" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    <table id="tbl" runat="server" class="xzll" cellpadding="0" border="0">
        ...
        <tr>
            ...
            <td class="sr">
                <uc1:ctrlTextBoxEx labelTitle="卷内备考" ID="note" width="290" height="60"
