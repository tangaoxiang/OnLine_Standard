...
namespace DigiPower.Onlinecol.Standard.DbUtility
{
    ...
    public abstract class DbHelperSQL
    {
        ...
        /// <returns></returns>
        public static rtnvalues QueryValues(string StoredProcedureName, InParameter[] InparameterValues, OutParameter[] OutparameterValues)
        {
            rtnvalues rtnv = new rtnvalues();
            ...
            {
                db.AddInParameter(cmd, InparameterValues[i].name, InparameterValues[i].dbType, InparameterValues[i].value);
            }
            //添加存储过程出口参数
