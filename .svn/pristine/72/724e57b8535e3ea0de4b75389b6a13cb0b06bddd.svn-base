...
namespace DigiPower.Onlinecol.Standard.Web
{
    public class EXIFMetaData
    {
        ...
        {
            public MetadataDetail EquipmentMake; //相机品牌
            public MetadataDetail CameraModel; //相机想好
            public MetadataDetail ExposureTime;//曝光时间 
            public MetadataDetail Fstop;     //光圈值
            ...
            public MetadataDetail PStime;// added  
        ...
        public Metadata GetEXIFMetaData(string PhotoName)
        {
            ...
            MyMetadata.EquipmentMake.Hex = "10f";     //设备制造商
            MyMetadata.CameraModel.Hex = "110";       // 设备型号
            MyMetadata.DatePictureTaken.Hex = "9003";  //拍摄时间
            MyMetadata.ExposureTime.Hex = "829a";      //曝光时间
            MyMetadata.Fstop.Hex = "829d";     // 
            MyMetadata.ShutterSpeed.Hex = "9201"; //快门速度
            MyMetadata.MeteringMode.Hex = "9207"; //曝光模式
            MyMetadata.Flash.Hex = "9209";       //闪光灯
            MyMetadata.FNumber.Hex = "829d"; // .曝光时间    
            MyMetadata.ExposureProg.Hex = ""; //曝光程序  
            MyMetadata.SpectralSense.Hex = "8824"; //added  
            MyMetadata.ISOSpeed.Hex = "8827"; // 感光度  
            MyMetadata.OECF.Hex = "8828"; //added  
            MyMetadata.Ver.Hex = "9000"; //EXIF版本  
            MyMetadata.CompConfig.Hex = "9101"; //色彩设置  
            MyMetadata.CompBPP.Hex = "9102"; //压缩比率  
            MyMetadata.Aperture.Hex = "9202"; //added  
            MyMetadata.Brightness.Hex = "9203"; //亮度值  
            MyMetadata.ExposureBias.Hex = "9204"; //曝光补偿  
            MyMetadata.MaxAperture.Hex = "9205"; //最大光圈数  
            MyMetadata.SubjectDist.Hex = "9206"; //added  
            MyMetadata.LightSource.Hex = "9208"; //光源  
            MyMetadata.FocalLength.Hex = "920a"; //焦距  
            MyMetadata.FPXVer.Hex = "a000"; //added  
            MyMetadata.ColorSpace.Hex = "a001"; //色彩空间  
            MyMetadata.FocalXRes.Hex = "a20e"; //added  
            MyMetadata.FocalYRes.Hex = "a20f"; //added  
            MyMetadata.FocalResUnit.Hex = "a210"; //added  
            MyMetadata.ExposureIndex.Hex = "a215"; //曝光指数  
            MyMetadata.SensingMethod.Hex = "a217"; //感应方式  
            MyMetadata.SceneType.Hex = "a301";
            MyMetadata.CfaPattern.Hex = "a302";

            MyMetadata.PStime.Hex = "132";       // 拍照时间 
            #endregion
            ...
            if (MyPropertyIdListCount != 0)
            {
                foreach (int MyPropertyId in MyPropertyIdList)
                {
                    ...
                    switch (myPropertyIdString)
                    {
                        ...
                        case "132":
                            {
                                MyMetadata.PStime.RawValueAsString = GetValueOfType2(MyImage.GetPropertyItem(MyPropertyId).Value);
                                MyMetadata.PStime.DisplayValue = GetValueOfType2(MyImage.GetPropertyItem(MyPropertyId).Value);
                                break;
                            }
