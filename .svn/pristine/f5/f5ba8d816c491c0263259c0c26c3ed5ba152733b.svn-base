...
<body>
    <form id="form1" runat="server">
        ...
        <strong style="color: red; font-size: 13px;">说明:单份文件最大<%= DigiPower.Onlinecol.Standard.Web.SystemSet._FILESIZE%>M,文件格式:<%= DigiPower.Onlinecol.Standard.Web.SystemSet._FILELISTFILEEXT%>
        </strong>
    </form>
</body>
</html>
