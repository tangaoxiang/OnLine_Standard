...
{
	/// <summary>
	/// 数据访问类b_single_project_DAL。
	/// </summary>
	public class b_single_project_DAL
	{
		public b_single_project_DAL()
		{}
		#region  成员方法
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("SingleProjectID", "b_single_project"); 
		}
		...
		public bool Exists(int SingleProjectID)
		{
			...
			strSql.Append("select count(1) from b_single_project");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into b_single_project(");
            strSql.Append("SingleProjectID,dxgcmc,sgdw,zlaqjddw,ghxkzh,sgxkzh,jglx,jzmj,kd,gd,kj,ks,jb,hz,jk,chd,jgsj,kgsj,gczj,gcjs,ajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,zrsbh,lxr,lxdh,gisid,ywzd,zlyj,gc_code,YDXKZH,ydghxkzh,HJQK,SJDW_XMFZR,KCDW,KCDW_XMFZR,JLDW_XMFZR,SGDW_XMJL,ZJLGCS,ZYJLGCS,FBDW,FBDW_XMJL,FBDW_1,FBDW_1_XMJL,ZYGZ,XMZYZLJCY,SGBZZ,TBR,JSDW_SHR,JLDW_SHR,SHRQ,TJLB,FPSJ,FPR,SPR,SPR_DH,FP_BZ,mtdw,mtss,sjdw,jldw,kzdj,wzz,qlcd,hzbz,ztjg,qljk,dx,zs,bzxs,dl,ydfs,zys,zcd,gczl,qlkd,qllb,qlkd2,qljb,qlzh,dg,jj,fh,xj,zjs,fz)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@jglx", SqlDbType.VarChar,100),
					new SqlParameter("@jzmj", SqlDbType.Decimal,9),
					new SqlParameter("@kd", SqlDbType.Decimal,9),
					new SqlParameter("@gd", SqlDbType.Decimal,9),
					new SqlParameter("@kj", SqlDbType.Decimal,9),
					new SqlParameter("@ks", SqlDbType.Int,8),
					new SqlParameter("@jb", SqlDbType.VarChar,30),
					new SqlParameter("@hz", SqlDbType.VarChar,30),
					new SqlParameter("@jk", SqlDbType.Decimal,9),
					...
					new SqlParameter("@mtdw", SqlDbType.Decimal,9),
					new SqlParameter("@mtss", SqlDbType.Decimal,9),
					...
					new SqlParameter("@qlcd", SqlDbType.VarChar,50),
					new SqlParameter("@hzbz", SqlDbType.VarChar,50),
					new SqlParameter("@ztjg", SqlDbType.VarChar,50),
					new SqlParameter("@qljk", SqlDbType.VarChar,50),
					new SqlParameter("@dx", SqlDbType.VarChar,50),
					new SqlParameter("@zs", SqlDbType.VarChar,50),
					new SqlParameter("@bzxs", SqlDbType.VarChar,50),
					new SqlParameter("@dl", SqlDbType.VarChar,50),
					new SqlParameter("@ydfs", SqlDbType.VarChar,50),
					new SqlParameter("@zys", SqlDbType.VarChar,50),
					new SqlParameter("@zcd", SqlDbType.VarChar,50),
					new SqlParameter("@gczl", SqlDbType.VarChar,50),
					new SqlParameter("@qlkd", SqlDbType.VarChar,50),
					new SqlParameter("@qllb", SqlDbType.VarChar,50),
					new SqlParameter("@qlkd2", SqlDbType.VarChar,50),
					new SqlParameter("@qljb", SqlDbType.VarChar,50),
					new SqlParameter("@qlzh", SqlDbType.VarChar,50),
					new SqlParameter("@dg", SqlDbType.VarChar,50),
					new SqlParameter("@jj", SqlDbType.VarChar,50),
					new SqlParameter("@fh", SqlDbType.VarChar,50),
					new SqlParameter("@xj", SqlDbType.VarChar,50),
					new SqlParameter("@zjs", SqlDbType.VarChar,50),
			...
			parameters[3].Value = model.zlaqjddw;
			parameters[4].Value = model.ghxkzh;
			parameters[5].Value = model.sgxkzh;
			parameters[6].Value = model.jglx;
			parameters[7].Value = model.jzmj;
			parameters[8].Value = model.kd;
			parameters[9].Value = model.gd;
			parameters[10].Value = model.kj;
			parameters[11].Value = model.ks;
			parameters[12].Value = model.jb;
			parameters[13].Value = model.hz;
			parameters[14].Value = model.jk;
			parameters[15].Value = model.chd;
			parameters[16].Value = model.jgsj;
			parameters[17].Value = model.kgsj;
			parameters[18].Value = model.gczj;
			parameters[19].Value = model.gcjs;
			parameters[20].Value = model.ajs;
			parameters[21].Value = model.wz;
			parameters[22].Value = model.tzj;
			parameters[23].Value = model.tzz;
			parameters[24].Value = model.dt;
			parameters[25].Value = model.zp;
			parameters[26].Value = model.dp;
			parameters[27].Value = model.ly;
			parameters[28].Value = model.lx;
			parameters[29].Value = model.gp;
			parameters[30].Value = model.cd;
			parameters[31].Value = model.cp;
			parameters[32].Value = model.swp;
			parameters[33].Value = model.swz;
			parameters[34].Value = model.qt;
			parameters[35].Value = model.bgqx;
			parameters[36].Value = model.mj;
			parameters[37].Value = model.jgrq;
			parameters[38].Value = model.yjdw;
			parameters[39].Value = model.swh;
			parameters[40].Value = model.cfwz;
			parameters[41].Value = model.note;
			parameters[42].Value = model.lrr;
			parameters[43].Value = model.lrsj;
			parameters[44].Value = model.zrsbh;
			parameters[45].Value = model.lxr;
			parameters[46].Value = model.lxdh;
			parameters[47].Value = model.gisid;
			parameters[48].Value = model.ywzd;
			parameters[49].Value = model.zlyj;
			parameters[50].Value = model.gc_code;
			parameters[51].Value = model.YDXKZH;
			parameters[52].Value = model.ydghxkzh;
			parameters[53].Value = model.HJQK;
			parameters[54].Value = model.SJDW_XMFZR;
			parameters[55].Value = model.KCDW;
			parameters[56].Value = model.KCDW_XMFZR;
			parameters[57].Value = model.JLDW_XMFZR;
			parameters[58].Value = model.SGDW_XMJL;
			parameters[59].Value = model.ZJLGCS;
			parameters[60].Value = model.ZYJLGCS;
			parameters[61].Value = model.FBDW;
			parameters[62].Value = model.FBDW_XMJL;
			parameters[63].Value = model.FBDW_1;
			parameters[64].Value = model.FBDW_1_XMJL;
			parameters[65].Value = model.ZYGZ;
			parameters[66].Value = model.XMZYZLJCY;
			parameters[67].Value = model.SGBZZ;
			parameters[68].Value = model.TBR;
			parameters[69].Value = model.JSDW_SHR;
			parameters[70].Value = model.JLDW_SHR;
			parameters[71].Value = model.SHRQ;
			parameters[72].Value = model.TJLB;
			parameters[73].Value = model.FPSJ;
			parameters[74].Value = model.FPR;
			parameters[75].Value = model.SPR;
			parameters[76].Value = model.SPR_DH;
			parameters[77].Value = model.FP_BZ;
			parameters[78].Value = model.mtdw;
			parameters[79].Value = model.mtss;
			parameters[80].Value = model.sjdw;
			parameters[81].Value = model.jldw;
			parameters[82].Value = model.kzdj;
			parameters[83].Value = model.wzz;
			parameters[84].Value = model.qlcd;
			parameters[85].Value = model.hzbz;
			parameters[86].Value = model.ztjg;
			parameters[87].Value = model.qljk;
			parameters[88].Value = model.dx;
			parameters[89].Value = model.zs;
			parameters[90].Value = model.bzxs;
			parameters[91].Value = model.dl;
			parameters[92].Value = model.ydfs;
			parameters[93].Value = model.zys;
			parameters[94].Value = model.zcd;
			parameters[95].Value = model.gczl;
			parameters[96].Value = model.qlkd;
			parameters[97].Value = model.qllb;
			parameters[98].Value = model.qlkd2;
			parameters[99].Value = model.qljb;
			parameters[100].Value = model.qlzh;
			parameters[101].Value = model.dg;
			parameters[102].Value = model.jj;
			parameters[103].Value = model.fh;
			parameters[104].Value = model.xj;
			parameters[105].Value = model.zjs;
            parameters[106].Value = model.fz;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update b_single_project set ");
			...
			strSql.Append("mtdw=@mtdw,");
			strSql.Append("mtss=@mtss,");
			strSql.Append("sjdw=@sjdw,");
			strSql.Append("jldw=@jldw,");
			strSql.Append("kzdj=@kzdj,");
			strSql.Append("wzz=@wzz,");
			strSql.Append("qlcd=@qlcd,");
			strSql.Append("hzbz=@hzbz,");
			strSql.Append("ztjg=@ztjg,");
			strSql.Append("qljk=@qljk,");
			strSql.Append("dx=@dx,");
			strSql.Append("zs=@zs,");
			strSql.Append("bzxs=@bzxs,");
			strSql.Append("dl=@dl,");
			strSql.Append("ydfs=@ydfs,");
			strSql.Append("zys=@zys,");
			strSql.Append("zcd=@zcd,");
			strSql.Append("gczl=@gczl,");
			strSql.Append("qlkd=@qlkd,");
			strSql.Append("qllb=@qllb,");
			strSql.Append("qlkd2=@qlkd2,");
			strSql.Append("qljb=@qljb,");
			strSql.Append("qlzh=@qlzh,");
			strSql.Append("dg=@dg,");
			strSql.Append("jj=@jj,");
			strSql.Append("fh=@fh,");
			strSql.Append("xj=@xj,");
		...
		public void Delete(int SingleProjectID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from b_single_project ");
			strSql.Append(" where SingleProjectID=@SingleProjectID ");
			SqlParameter[] parameters = {
					new SqlParameter("@SingleProjectID", SqlDbType.Int,8)};
			parameters[0].Value = SingleProjectID;
		...
		public DigiPower.Onlinecol.Standard.Model.b_single_project_MDL GetModel(int SingleProjectID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 SingleProjectID,dxgcmc,sgdw,zlaqjddw,ghxkzh,sgxkzh,jglx,jzmj,kd,gd,kj,ks,jb,hz,jk,chd,jgsj,kgsj,gczj,gcjs,ajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,zrsbh,lxr,lxdh,gisid,ywzd,zlyj,gc_code,YDXKZH,ydghxkzh,HJQK,SJDW_XMFZR,KCDW,KCDW_XMFZR,JLDW_XMFZR,SGDW_XMJL,ZJLGCS,ZYJLGCS,FBDW,FBDW_XMJL,FBDW_1,FBDW_1_XMJL,ZYGZ,XMZYZLJCY,SGBZZ,TBR,JSDW_SHR,JLDW_SHR,SHRQ,TJLB,FPSJ,FPR,SPR,SPR_DH,FP_BZ,mtdw,mtss,sjdw,jldw,kzdj,wzz,qlcd,hzbz,ztjg,qljk,dx,zs,bzxs,dl,ydfs,zys,zcd,gczl,qlkd,qllb,qlkd2,qljb,qlzh,dg,jj,fh,xj,zjs,fz from b_single_project ");
			strSql.Append(" where SingleProjectID=@SingleProjectID ");
			SqlParameter[] parameters = {
					new SqlParameter("@SingleProjectID", SqlDbType.Int,8)};
			parameters[0].Value = SingleProjectID;

			DigiPower.Onlinecol.Standard.Model.b_single_project_MDL model=new DigiPower.Onlinecol.Standard.Model.b_single_project_MDL();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["kd"].ToString()!="")
				{
					model.kd=decimal.Parse(ds.Tables[0].Rows[0]["kd"].ToString());
				}
				if(ds.Tables[0].Rows[0]["gd"].ToString()!="")
				{
					model.gd=decimal.Parse(ds.Tables[0].Rows[0]["gd"].ToString());
				}
				if(ds.Tables[0].Rows[0]["kj"].ToString()!="")
				{
					model.kj=decimal.Parse(ds.Tables[0].Rows[0]["kj"].ToString());
				}
				if(ds.Tables[0].Rows[0]["ks"].ToString()!="")
				{
					model.ks=int.Parse(ds.Tables[0].Rows[0]["ks"].ToString());
				}
				model.jb=ds.Tables[0].Rows[0]["jb"].ToString();
				model.hz=ds.Tables[0].Rows[0]["hz"].ToString();
				if(ds.Tables[0].Rows[0]["jk"].ToString()!="")
				{
					model.jk=decimal.Parse(ds.Tables[0].Rows[0]["jk"].ToString());
				}
				...
				if(ds.Tables[0].Rows[0]["mtdw"].ToString()!="")
				{
					model.mtdw=decimal.Parse(ds.Tables[0].Rows[0]["mtdw"].ToString());
				}
				if(ds.Tables[0].Rows[0]["mtss"].ToString()!="")
				{
					model.mtss=decimal.Parse(ds.Tables[0].Rows[0]["mtss"].ToString());
				}
				...
				model.qlcd=ds.Tables[0].Rows[0]["qlcd"].ToString();
				model.hzbz=ds.Tables[0].Rows[0]["hzbz"].ToString();
				model.ztjg=ds.Tables[0].Rows[0]["ztjg"].ToString();
				model.qljk=ds.Tables[0].Rows[0]["qljk"].ToString();
				model.dx=ds.Tables[0].Rows[0]["dx"].ToString();
				model.zs=ds.Tables[0].Rows[0]["zs"].ToString();
				model.bzxs=ds.Tables[0].Rows[0]["bzxs"].ToString();
				model.dl=ds.Tables[0].Rows[0]["dl"].ToString();
				model.ydfs=ds.Tables[0].Rows[0]["ydfs"].ToString();
				model.zys=ds.Tables[0].Rows[0]["zys"].ToString();
				model.zcd=ds.Tables[0].Rows[0]["zcd"].ToString();
				model.gczl=ds.Tables[0].Rows[0]["gczl"].ToString();
				model.qlkd=ds.Tables[0].Rows[0]["qlkd"].ToString();
				model.qllb=ds.Tables[0].Rows[0]["qllb"].ToString();
				model.qlkd2=ds.Tables[0].Rows[0]["qlkd2"].ToString();
				model.qljb=ds.Tables[0].Rows[0]["qljb"].ToString();
				model.qlzh=ds.Tables[0].Rows[0]["qlzh"].ToString();
				model.dg=ds.Tables[0].Rows[0]["dg"].ToString();
				model.jj=ds.Tables[0].Rows[0]["jj"].ToString();
				model.fh=ds.Tables[0].Rows[0]["fh"].ToString();
				model.xj=ds.Tables[0].Rows[0]["xj"].ToString();
				model.zjs=ds.Tables[0].Rows[0]["zjs"].ToString();
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select SingleProjectID,dxgcmc,sgdw,zlaqjddw,ghxkzh,sgxkzh,jglx,jzmj,kd,gd,kj,ks,jb,hz,jk,chd,jgsj,kgsj,gczj,gcjs,ajs,wz,tzj,tzz,dt,zp,dp,ly,lx,gp,cd,cp,swp,swz,qt,bgqx,mj,jgrq,yjdw,swh,cfwz,note,lrr,lrsj,zrsbh,lxr,lxdh,gisid,ywzd,zlyj,gc_code,YDXKZH,ydghxkzh,HJQK,SJDW_XMFZR,KCDW,KCDW_XMFZR,JLDW_XMFZR,SGDW_XMJL,ZJLGCS,ZYJLGCS,FBDW,FBDW_XMJL,FBDW_1,FBDW_1_XMJL,ZYGZ,XMZYZLJCY,SGBZZ,TBR,JSDW_SHR,JLDW_SHR,SHRQ,TJLB,FPSJ,FPR,SPR,SPR_DH,FP_BZ,mtdw,mtss,sjdw,jldw,kzdj,wzz,qlcd,hzbz,ztjg,qljk,dx,zs,bzxs,dl,ydfs,zys,zcd,gczl,qlkd,qllb,qlkd2,qljb,qlzh,dg,jj,fh,xj,zjs,fz ");
			strSql.Append(" FROM b_single_project ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "b_single_project";
